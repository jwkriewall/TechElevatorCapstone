...
UPDATE users SET user_id = ?, user_first_name = ?, user_last_name = ?, user_nickname = ?, user_email = ?, user_phone = ?, username = ?, password_hash = ? WHERE user_id = ?;
