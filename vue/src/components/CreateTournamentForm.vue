<template>
  <form v-on:submit.prevent="createTournament" class="tournamentForm">
        ...
        <div>
            ...
            <input type="text" id="name" name="name" v-model="tournament.name" />
        </div>
        <div>
        ...
        <div class="organizerInfo" v-if="!isOrganizer">
            ...
            <div>   
                ...
                <input type="tel" pattern="[0-9]{3}[0-9]{3}[0-9]{4}"  id="phone" v-model="organizer.phone" />
            </div>
            <div>   
                <label for="email">Email Address: </label>
                <input type="email" id="email" v-model="organizer.email" />
            </div>
        </div>
...
.toggleSwitch:not(.toggleSwitch:first-of-type) { 
    margin-top:-30px; 
}
