...
<div class="brackets">
  <header class="hero">
    <div class="hero-wrap">
     ...
     <h1 id="headline">BRCKT</h1>
     <p class="year"><i class="star"></i>{{ tournament.startDate.getMonth() }}<i class="star"></i></p>
   </div>
  </header>
  ...
  <div class="split split-one">
    <div class="round round-one current" v-if="tournament.maxParticipants >= 9">
      <div class="round-details">Round 1<br/><span class="date">{{ tournament.startDate.getDay() }}</span></div>
      <ul class="matchup">
        <li class="team team-top">{{ rankings.rank == 1 ? (rankings.nickname ? rankings.nickname :  rankings.name) : '' }}<span class="score"></span></li>
        <li class="team team-bottom">{{ rankings.rank == 16 ? (rankings.nickname ? rankings.nickname :  rankings.name) : '' }}<span class="score"></span></li>
      </ul>
      <ul class="matchup">
        <li class="team team-top">{{ rankings.rank == 9 ? (rankings.nickname ? rankings.nickname :  rankings.name) : '' }}<span class="score"></span></li>
        <li class="team team-bottom">{{ rankings.rank == 8 ? (rankings.nickname ? rankings.nickname :  rankings.name) : '' }}<span class="score"></span></li>
      </ul>
      <ul class="matchup">
        <li class="team team-top">{{ rankings.rank == 5 ? (rankings.nickname ? rankings.nickname :  rankings.name) : '' }}<span class="score"></span></li>
        <li class="team team-bottom">{{ rankings.rank == 12 ? (rankings.nickname ? rankings.nickname :  rankings.name) : '' }}<span class="score"></span></li>
      </ul>
      <ul class="matchup">
        <li class="team team-top">{{ rankings.rank == 13 ? (rankings.nickname ? rankings.nickname :  rankings.name) : '' }}<span class="score"></span></li>
        <li class="team team-bottom">{{ rankings.rank == 4 ? (rankings.nickname ? rankings.nickname :  rankings.name) : '' }}<span class="score"></span></li>
      </ul>     
      <ul class="matchup">
        <li class="team team-top">{{ rankings.rank == 3 ? (rankings.nickname ? rankings.nickname :  rankings.name) : '' }}<span class="score"></span></li>
        <li class="team team-bottom">{{ rankings.rank == 14 ? (rankings.nickname ? rankings.nickname :  rankings.name) : '' }}<span class="score"></span></li>
      </ul> 
      <ul class="matchup">
        <li class="team team-top">{{ rankings.rank == 6 ? (rankings.nickname ? rankings.nickname :  rankings.name) : '' }}<span class="score"></span></li>
        <li class="team team-bottom">{{ rankings.rank == 11 ? (rankings.nickname ? rankings.nickname :  rankings.name) : '' }}<span class="score"></span></li>
      </ul> 
      <ul class="matchup">
        <li class="team team-top">{{ rankings.rank == 7 ? (rankings.nickname ? rankings.nickname :  rankings.name) : '' }}<span class="score"></span></li>
        <li class="team team-bottom">{{ rankings.rank == 10 ? (rankings.nickname ? rankings.nickname :  rankings.name) : '' }}<span class="score"></span></li>
      </ul>
      <ul class="matchup">
        <li class="team team-top">{{ rankings.rank == 15 ? (rankings.nickname ? rankings.nickname :  rankings.name) : '' }}<span class="score"></span></li>
        <li class="team team-bottom">{{ rankings.rank == 2 ? (rankings.nickname ? rankings.nickname :  rankings.name) : '' }}<span class="score"></span></li>
      </ul>                   
    </div>  <!-- END ROUND ONE -->
...
export default {
  ...
  data() {
    return {
      tournament: {},
      tournamentId: this.$router.params.id,
      rankings: {},
    }
  },
  created() {
    tournamentService.getTournament(this.$router.params.id).then( response => {
      if(response.status === 200) {
        this.tournament = response.status
        tournamentService.getTournamentRankings(this.tournament.id);
      }
    })
