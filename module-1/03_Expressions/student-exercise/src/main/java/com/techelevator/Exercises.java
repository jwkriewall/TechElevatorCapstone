...
public class Exercises {
	...
	/*
	 ...
	 Unless it is the weekend, in which case
	...
	public boolean cigarParty(int cigars, boolean isWeekend) {
		...
		if (!isWeekend && ((cigars > 30) && (cigars < 61))) {
			return true;
		}
		return false;
	}
	...
	/*
	 ...
	 The result returned will be 0 if you did not get the table, 1 if you might get the table, and 2 if you did get
	 the table. If you or your date is very stylish (8 or more), then the result is 2 (yes). 
	 With the exception that if either of you has style of 2 or less, then the result is 0 (no). Otherwise the
	 result is 1 (maybe).
	...
	/*
	 ...
	 less20(20) → false
	 */
	//I took the long way home XD
	public boolean less20(int n) {
		if (n >= 0) {
			if (n % 20 == 0 || n % 20 == 1 || n % 20 == 2 || n % 20 == 3 || n % 20 == 4 || n % 20 == 5 || n % 20 == 6 || n % 20 == 7) {
				return false;
			}
		}
		return true;
	...
	/*
	 27. Given a non-negative number "num", 
	...
	/*
	 ...
	 However, "teen" values in the range 13..19 inclusive, are
	...
	/*
	 29. Your cell phone rings. Return true if you should answer it. 
	 Normally you answer, except in the morning
	 you only answer if it is your mom calling. 
	...
	/*
	 35. Given 3 int values, a b c, return their sum. 
